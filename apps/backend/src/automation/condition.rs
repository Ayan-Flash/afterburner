...
impl ConditionEvaluator {
    ...
    fn extract_metric(metric: &str, sample: &crate::hardware::GpuSample) -> Option<f64> {
        match metric {
            ...
            "core_clock" | "core_mhz" => Some(sample.core_clock_mhz as f64),
            "memory_clock" | "mem_mhz" => Some(sample.memory_clock_mhz as f64),
            "fan_speed" | "fan" | "fan_percent" => Some(sample.fan_speed_percent as f64),
            ...
            "core_voltage" | "voltage" => Some(sample.core_voltage_mv as f64),
